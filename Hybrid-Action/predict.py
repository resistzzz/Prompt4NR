...
if __name__ == '__main__':
    ...
    # Whether ration = x, using all test set for testing
    parser.add_argument('--ratio', default=0.5, type=float, help='ratio of all datasets')   # Only give a identifier for log_file name to record the model trained by how many training set
